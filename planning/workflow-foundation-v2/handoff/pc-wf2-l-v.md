...
Role `specialist`; workspace mode `isolated_merge`. Parent `PC-WF2-L-COORD`.

## Serial queue

1. `PC-WF2-V01` — Build the differential test harness and baseline fixtures
2. `PC-WF2-V02` — Differentially qualify workflow and persistence parity
3. `PC-WF2-V03` — Attack the unified authority and compatibility boundary
4. `PC-WF2-V04` — Qualify the candidate end to end and rehearse rollback
