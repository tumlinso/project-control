...
1. `PC-WF2-A01` — Freeze the current product, authority, and compatibility baseline
2. `PC-WF2-A02` — Establish isolated test and rollback environments
3. `PC-WF2-A03` — Verify low-cost research routing before fan-out
