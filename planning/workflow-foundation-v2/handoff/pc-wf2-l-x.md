...
1. `PC-WF2-X01` — Verify and import the Skills donor baseline
2. `PC-WF2-X02` — Verify the standalone ctxpp query capability
3. `PC-WF2-X03` — Verify the Skills consumer-ready candidate
4. `PC-WF2-X04` — Verify Skills final closure after cutover
