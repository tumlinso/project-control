...
1. `PC-WF2-Q01` — Use ctxpp through a supported read-only query contract
2. `PC-WF2-Q02` — Repair source pagination and search selectivity
3. `PC-WF2-Q03` — Bind source evidence to actual selected bytes and worktrees
4. `PC-WF2-Q04` — Qualify source routing precision and boundedness
