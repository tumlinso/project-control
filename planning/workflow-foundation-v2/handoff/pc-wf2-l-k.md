...
1. `PC-WF2-K01` — Import the identified Todo package and tests without redesign
2. `PC-WF2-K02` — Preserve database transactions and durable projections
3. `PC-WF2-K03` — Preserve workflow protocol and capability behavior
4. `PC-WF2-K04` — Preserve sidecars and external runtime contracts
5. `PC-WF2-K05` — Qualify the complete relocated core
