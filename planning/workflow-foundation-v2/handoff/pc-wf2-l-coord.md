...
Role `coordinator`; workspace mode `read_shared`. Parent `none; local root`.

## Serial queue

1. `PC-WF2-COORD` — Coordinate the accepted program; close only after final local integration
2. `PC-WF2-0000` — Workflow Foundation v2 — project-control aggregate
