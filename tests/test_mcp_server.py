...
class MCPServerTests(unittest.TestCase):
    ...
    def test_exact_tools_annotations_and_schema_budget(self) -> None:
        ...
        self.assertEqual(schemas["local_investigate"]["properties"]["parallelism"]["enum"], ["default", "layer", "row", "tensor"])
    ...
    def test_health_ready_version_and_nonloopback_refusal(self) -> None:
        with TestClient(create_asgi_app(self.config)) as client:
            ...
            self.assertEqual(client.get("/version").json(), {"name": "project-control", "version": "0.3.2", "tool_schema_version": 6})
